...
public:
  ...
  void SetSubtitleExtTrackName(const std::string &strFilenameAndPath, const std::string &subTrackName);
  std::string GetSubtitleExtTrackName(const std::string &strFilenameAndPath);
