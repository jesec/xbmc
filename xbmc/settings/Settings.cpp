...
{
#ifdef HAS_DS_PLAYER 
  GetSettingsManager()->UnregisterSettingOptionsFiller("dsvideorenderer");
  GetSettingsManager()->UnregisterSettingOptionsFiller("dsaudiorenderer");
  GetSettingsManager()->UnregisterSettingOptionsFiller("saneardevices");
  GetSettingsManager()->UnregisterSettingOptionsFiller("dsextrafilter");
#endif
